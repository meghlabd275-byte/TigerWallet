# TigerWallet Bot Platform

## Overview

TigerWallet provides 18 trading bot types (9 standard retail bots plus MM/MEV/AI
bots) with role-based access control. Bots can connect to 20+ DEXs and 200+
CEXs. Full bot/strategy reference: [`docs/BOTS_CLIENTS.md`](docs/BOTS_CLIENTS.md).
...
- **Email:** bots@tigerwallet.com
- **Discord:** https://discord.gg/tigerwallet
- **Documentation:** [`docs/BOTS_CLIENTS.md`](docs/BOTS_CLIENTS.md)