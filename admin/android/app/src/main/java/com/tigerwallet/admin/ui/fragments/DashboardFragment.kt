...
import com.tigerwallet.admin.data.repository.*
...
import com.tigerwallet.admin.data.model.AnalyticsData
import com.tigerwallet.admin.data.repository.AnalyticsRepository
...
class UsersFragment : Fragment() {
    ...
    private lateinit var userRepository: com.tigerwallet.admin.data.repository.UserRepository
    private var users: List<com.tigerwallet.admin.data.model.PlatformUser> = emptyList()
    ...
    private fun updateUsersList(users: List<com.tigerwallet.admin.data.model.PlatformUser>) {
...
class TransactionsFragment : Fragment() {
    ...
    private lateinit var transactionRepository: com.tigerwallet.admin.data.repository.TransactionRepository
    private var transactions: List<com.tigerwallet.admin.data.model.Transaction> = emptyList()
    ...
    private fun updateTransactionsList(transactions: List<com.tigerwallet.admin.data.model.Transaction>) {
...
class KYCFragment : Fragment() {
    ...
    private lateinit var kycRepository: com.tigerwallet.admin.data.repository.KYCRepository
    private var applications: List<com.tigerwallet.admin.data.model.KYCApplication> = emptyList()
    ...
    private fun updateKYCList(applications: List<com.tigerwallet.admin.data.model.KYCApplication>) {
...
class TokensFragment : Fragment() {
    ...
    private lateinit var tokenRepository: com.tigerwallet.admin.data.repository.TokenRepository
    private var tokens: List<com.tigerwallet.admin.data.model.Token> = emptyList()
    ...
    private fun updateTokensList(tokens: List<com.tigerwallet.admin.data.model.Token>) {
...
class WithdrawalsFragment : Fragment() {
    ...
    private lateinit var withdrawalRepository: com.tigerwallet.admin.data.repository.WithdrawalRepository
    private var withdrawals: List<com.tigerwallet.admin.data.model.WithdrawalRequest> = emptyList()
    ...
    private fun updateWithdrawalsList(withdrawals: List<com.tigerwallet.admin.data.model.WithdrawalRequest>) {
...
class SystemFragment : Fragment() {
    ...
    private lateinit var systemRepository: com.tigerwallet.admin.data.repository.SystemRepository
    ...
    private fun updateSystemStatus(status: com.tigerwallet.admin.data.model.SystemStatus) {
