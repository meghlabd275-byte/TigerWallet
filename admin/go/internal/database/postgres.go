...
func runMigrations(ctx context.Context) error {
	migrations := []string{
		...
		// --- Trading admin domain governance tables (mirror super_admin/go commit 0cb13d7) ---
		`CREATE TABLE IF NOT EXISTS futures_positions (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), user_id UUID, pair TEXT NOT NULL, side TEXT NOT NULL, size NUMERIC NOT NULL DEFAULT 0, leverage NUMERIC NOT NULL DEFAULT 1, entry_price NUMERIC NOT NULL DEFAULT 0, liquidation_price NUMERIC NOT NULL DEFAULT 0, margin NUMERIC NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'open', chain_id BIGINT, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS options_contracts (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), user_id UUID, underlying TEXT NOT NULL, option_type TEXT NOT NULL, strike NUMERIC NOT NULL DEFAULT 0, expiry TIMESTAMPTZ NOT NULL, premium NUMERIC NOT NULL DEFAULT 0, size NUMERIC NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'active', chain_id BIGINT, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS copy_trading_configs (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), follower_id UUID, leader_id UUID, allocation NUMERIC NOT NULL DEFAULT 0, max_leverage NUMERIC NOT NULL DEFAULT 1, status TEXT NOT NULL DEFAULT 'active', created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS convert_orders (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), user_id UUID, from_token TEXT NOT NULL, to_token TEXT NOT NULL, from_amount NUMERIC NOT NULL DEFAULT 0, to_amount NUMERIC NOT NULL DEFAULT 0, rate NUMERIC NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'pending', chain_id BIGINT, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS onramp_orders (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), user_id UUID, provider TEXT NOT NULL, fiat_currency TEXT NOT NULL, crypto_token TEXT NOT NULL, fiat_amount NUMERIC NOT NULL DEFAULT 0, crypto_amount NUMERIC NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'pending', payment_ref TEXT, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS offramp_orders (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), user_id UUID, provider TEXT NOT NULL, crypto_token TEXT NOT NULL, fiat_currency TEXT NOT NULL, crypto_amount NUMERIC NOT NULL DEFAULT 0, fiat_amount NUMERIC NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'pending', payout_ref TEXT, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS p2p_clients (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), user_id UUID, username TEXT NOT NULL, status TEXT NOT NULL DEFAULT 'active', rating NUMERIC DEFAULT 0, trades_count INT DEFAULT 0, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS partners (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), name TEXT NOT NULL, contact_email TEXT, api_key TEXT UNIQUE, status TEXT NOT NULL DEFAULT 'pending', revenue_share NUMERIC DEFAULT 0, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS reward_campaigns (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), name TEXT NOT NULL, reward_type TEXT NOT NULL, amount NUMERIC NOT NULL DEFAULT 0, token TEXT, status TEXT NOT NULL DEFAULT 'active', start_at TIMESTAMPTZ, end_at TIMESTAMPTZ, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS marketing_campaigns (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), name TEXT NOT NULL, channel TEXT NOT NULL, budget NUMERIC NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'draft', start_at TIMESTAMPTZ, end_at TIMESTAMPTZ, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		// --- Structured RBAC tables (mirror super_admin/go commit 15e99eb) ---
		`CREATE TABLE IF NOT EXISTS admin_roles (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), name VARCHAR(255) UNIQUE NOT NULL, description TEXT, permissions TEXT[] NOT NULL DEFAULT '{}', is_system BOOLEAN NOT NULL DEFAULT FALSE, is_active BOOLEAN NOT NULL DEFAULT TRUE, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS admin_permissions (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), name VARCHAR(255) UNIQUE NOT NULL, description TEXT, category VARCHAR(100) NOT NULL DEFAULT 'general', is_active BOOLEAN NOT NULL DEFAULT TRUE, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW())`,
		`CREATE TABLE IF NOT EXISTS admin_role_assignments (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), admin_id UUID NOT NULL, role_id UUID NOT NULL REFERENCES admin_roles(id) ON DELETE CASCADE, granted_by UUID, granted_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), UNIQUE(admin_id, role_id))`,
