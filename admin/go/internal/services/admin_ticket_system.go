/**
 * TigerWallet Admin Support AdminTicket System
 * Complete Support AdminTicket Management with Knowledge Base
 *
 * Features:
 * - AdminTicket creation and management
 * - AdminTicket assignment and escalation
 * - Status tracking
 * - Priority levels
 * - Internal notes
...
type AdminTicketComment struct {
	ID         string    `json:"id"`
...
type AdminKnowledgeBaseArticle struct {
	ID         string    `json:"id"`
...
func NewAdminAdminTicketService(config *TicketConfig, db *gorm.DB, redisClient *redis.Client) *AdminTicketService {
...
// ============================================================================
// AdminTicket CRUD Operations
// ============================================================================

func (s *AdminTicketService) CreateTicket(ticket *AdminTicket) error {
...
func (s *AdminTicketService) GetTicket(id string) (*AdminTicket, error) {
...
func (s *AdminTicketService) UpdateTicket(ticket *AdminTicket) error {
	ticket.UpdatedAt = time.Now()
...
func (s *AdminTicketService) DeleteTicket(id string) error {
...
func (s *AdminTicketService) ListTickets(filters map[string]string) ([]*AdminTicket, int64, error) {
	...
	tickets := make([]*AdminTicket, 0, len(ticketIDs))
...
// ============================================================================
// AdminTicket Comments
// ============================================================================

func (s *AdminTicketService) AddComment(comment *AdminTicketComment) error {
...
func (s *AdminTicketService) GetComments(ticketID string) ([]*AdminTicketComment, error) {
	commentsJSON, err := s.redis.LRange(context.Background(), "ticket:"+ticketID+":comments", 0, -1).Result()
	if err != nil {
		return nil, err
	}

	comments := make([]*AdminTicketComment, 0, len(commentsJSON))
	for _, c := range commentsJSON {
		var comment AdminTicketComment
...
func (s *AdminTicketService) CreateArticle(article *AdminKnowledgeBaseArticle) error {
...
func (s *AdminTicketService) GetArticle(id string) (*AdminKnowledgeBaseArticle, error) {
	articleJSON, err := s.redis.Get(context.Background(), "kb:article:"+id).Result()
	if err != nil {
		return nil, err
	}

	var article AdminKnowledgeBaseArticle
...
func (s *AdminTicketService) UpdateArticle(article *AdminKnowledgeBaseArticle) error {
	article.UpdatedAt = time.Now()
...
func (s *AdminTicketService) SearchArticles(query string) ([]*AdminKnowledgeBaseArticle, error) {
	// Search across all categories
	categories := []string{"general", "technical", "billing", "security", "kyc", "withdrawal"}

	results := make([]*AdminKnowledgeBaseArticle, 0)
...
func (s *AdminTicketService) ArticleFeedback(articleID, helpful string) error {
	if helpful == "yes" {
...
func (s *AdminTicketService) CreateCannedResponse(response *CannedResponse) error {
...
func (s *AdminTicketService) GetCannedResponses(category string) ([]*CannedResponse, error) {
...
func (s *AdminTicketService) GetSLAStatus(ticketID string) (*SLATracking, error) {
...
func (s *AdminTicketService) GetStats() (map[string]interface{}, error) {
...
func (s *AdminTicketService) CreateTicketHandler(c *gin.Context) {
	var ticket AdminTicket
...
func (s *AdminTicketService) GetTicketHandler(c *gin.Context) {
	id := c.Param("id")

	ticket, err := s.GetTicket(id)
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"error": "AdminTicket not found"})
		return
	}
...
func (s *AdminTicketService) UpdateTicketHandler(c *gin.Context) {
	id := c.Param("id")
...
func (s *AdminTicketService) ListTicketsHandler(c *gin.Context) {
...
func (s *AdminTicketService) AddCommentHandler(c *gin.Context) {
	var comment AdminTicketComment
...
func (s *AdminTicketService) GetCommentsHandler(c *gin.Context) {
	ticketID := c.Param("id")
...
func (s *AdminTicketService) CreateArticleHandler(c *gin.Context) {
	var article AdminKnowledgeBaseArticle
...
func (s *AdminTicketService) SearchArticlesHandler(c *gin.Context) {
	query := c.Query("q")
	if query == "" {
...
func (s *AdminTicketService) GetStatsHandler(c *gin.Context) {
...
func (s *AdminTicketService) CreateCannedResponseHandler(c *gin.Context) {
	var response CannedResponse
...
func (s *AdminTicketService) GetCannedResponsesHandler(c *gin.Context) {
