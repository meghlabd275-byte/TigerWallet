// feature_flags.go — downstream feature-flag enforcement layer for the swap
// service.
//
...
const FeatureSwapTrading = "swap_trading"
...
// redisClientForFlags returns the swap service Redis client used to read flag
// state. Returns nil when the service / Redis is not initialized (fail-closed
// downstream).
func (ss *SwapService) redisClientForFlags() *redis.Client {
...
func (ss *SwapService) FeatureState(featureName string) string {
	if featureName == "" {
...
func (ss *SwapService) fetchFeatureState(featureName string) string {
...
func (ss *SwapService) IsFeatureEnabled(featureName string) bool {
...
func (ss *SwapService) InvalidateFeatureCache(featureName string) {
	flagCacheMu.Lock()
...
//
//	if !ss.enforceFeature(c, FeatureSwapTrading) { return }
func (ss *SwapService) enforceFeature(c *gin.Context, featureName string) bool {
