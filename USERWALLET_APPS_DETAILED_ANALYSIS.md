...
**Not a crypto wallet** — theme toggle + links only. `popup.js:4-8` toggles theme,
opens `http://localhost:8105` (L14), `/wallets` (L18), `/transactions` (L22).
**No fetchers.**
...
→ Correctly targets main.go backend.
