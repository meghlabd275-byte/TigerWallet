...
func (s *NotificationService) NotifyKYC(userID, status, adminID string) {
...
func (s *NotificationService) NotifyWithdrawal(withdrawalID, status, adminID string) {
	notification := &Notification{
		ID:       uuid.New().String(),
...
func (s *NotificationService) NotifyTransaction(transactionID, status string) {
	notification := &Notification{
		ID:       uuid.New().String(),
...
func (s *NotificationService) NotifySecurity(event, details string) {
	notification := &Notification{
		ID:       uuid.New().String(),
...
func (s *NotificationService) NotifySystem(message string) {
	notification := &Notification{
		ID:        uuid.New().String(),
