...
export const AIRDROP_SERVICE_URL = process.env.AIRDROP_SERVICE_URL || 'http://localhost:8465';
export const EARN_SERVICE_URL = process.env.EARN_SERVICE_URL || 'http://localhost:8466';
export const COUPON_SERVICE_URL = process.env.COUPON_SERVICE_URL || 'http://localhost:8467';
export const RED_PACKETS_SERVICE_URL = process.env.RED_PACKETS_SERVICE_URL || 'http://localhost:8468';
export const GIFT_CARD_SERVICE_URL = process.env.GIFT_CARD_SERVICE_URL || 'http://localhost:8469';
export const AA_SERVICE_URL = process.env.AA_SERVICE_URL || 'http://localhost:8081';
export const OPTIONS_SERVICE_URL = process.env.OPTIONS_SERVICE_URL || 'http://localhost:9097';
