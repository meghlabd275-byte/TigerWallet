  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-2">Embedded Wallet SDK</h1>
        <p className="text-slate-400 mb-8">Integrate TigerWallet into your app</p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Configuration */}
          <div>
            <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 mb-6">
              <h2 className="text-xl font-semibold text-white mb-4">Customize Widget</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-slate-400 text-sm mb-2">Accent Color</label>
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              <div className="bg-slate-800 rounded-xl p-4 border border-slate-700">
                <h3 className="text-white font-medium mb-2">Supported Platforms</h3>
                <div className="flex gap-2 flex-wrap">
                  {['React', 'Vue', 'Angular', 'Next.js', 'iOS', 'Android', 'Unity'].map(platform => (
                    <span key={platform} className="px-3 py-1 bg-slate-700 rounded-full text-sm text-slate-300">
                      {platform}
                    </span>
                  ))}
                </div>
