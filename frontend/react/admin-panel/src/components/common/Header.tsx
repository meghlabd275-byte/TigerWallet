// TigerWallet Header Component with Theme Toggle
    ...
    <header className="header">
      ...
      <div className="header__right">
        ...
        <button className="header__notification-btn">
          ...
          {notifications > 0 && (
            <span className="header__notification-badge">{notifications}</span>
          )}
        </button>
        ...
        <div className="header__user">
          ...
          {userMenuOpen && (
            <div className="header__user-dropdown">
              ...
              <a href="#logout" className="header__dropdown-item header__dropdown-item--danger">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
