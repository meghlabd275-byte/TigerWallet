...
func (h *TokenHandler) CreateToken(c *gin.Context) {
	...
	// Log activity
	logAdminActivity(h.db, adminID, "create_token", "token", strconv.FormatUint(uint64(token.ID)), "Created token: "+token.Symbol, c.ClientIP(), c.Request.UserAgent())
