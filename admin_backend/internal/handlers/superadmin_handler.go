...
func (h *SuperAdminHandler) CreateAdmin(c *gin.Context) {
	...
	// Log activity
	h.logActivity(c.GetUint("admin_id"), "create_admin", "admin", strconv.FormatUint(uint64(admin.ID)), "Created new admin: "+admin.Email, c.ClientIP(), c.Request.UserAgent())
...
func (h *SuperAdminHandler) UpdateAdmin(c *gin.Context) {
	...
	h.logActivity(c.GetUint("admin_id"), "update_admin", "admin", strconv.FormatUint(id), "Updated admin", c.ClientIP(), c.Request.UserAgent())
...
func (h *SuperAdminHandler) DeleteAdmin(c *gin.Context) {
	...
	h.logActivity(c.GetUint("admin_id"), "delete_admin", "admin", strconv.FormatUint(id), "Deleted admin: "+admin.Email, c.ClientIP(), c.Request.UserAgent())
...
func (h *SuperAdminHandler) SuspendAdmin(c *gin.Context) {
	...
	// Revoke all sessions
	h.redis.DeleteUserSession("admin:" + strconv.FormatUint(id))

	h.logActivity(c.GetUint("admin_id"), "suspend_admin", "admin", strconv.FormatUint(id), "Suspended admin: "+req.Reason, c.ClientIP(), c.Request.UserAgent())
...
func (h *SuperAdminHandler) ActivateAdmin(c *gin.Context) {
	...
	h.logActivity(c.GetUint("admin_id"), "activate_admin", "admin", strconv.FormatUint(id), "Activated admin", c.ClientIP(), c.Request.UserAgent())
...
func (h *SuperAdminHandler) UpdateSystemConfig(c *gin.Context) {
	...
	h.logActivity(c.GetUint("admin_id"), "update_config", "config", "", "Updated system configuration", c.ClientIP(), c.Request.UserAgent())
...
func (h *SuperAdminHandler) UpdateFeatureFlag(c *gin.Context) {
	...
	h.logActivity(c.GetUint("admin_id"), "update_feature", "feature_flag", name, "Updated feature flag", c.ClientIP(), c.Request.UserAgent())
...
func (h *SuperAdminHandler) UpdateRateLimits(c *gin.Context) {
	...
	h.logActivity(c.GetUint("admin_id"), "update_rate_limits", "config", "", "Updated rate limits", c.ClientIP(), c.Request.UserAgent())
