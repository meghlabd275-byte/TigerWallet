...
func (h *APIKeyHandler) CreateAPIKey(c *gin.Context) {
	...
	logAdminActivity(h.db, adminID, "create_api_key", "api_key", strconv.FormatUint(uint64(newAPIKey.ID)), "Created API key: "+newAPIKey.Name, c.ClientIP(), c.Request.UserAgent())
