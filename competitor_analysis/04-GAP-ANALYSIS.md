...
Gaps #1, #3, #13, the theme UX gap, the ELF-binary hygiene gap, the NFT-mock-data gap, and the keystore-V3-interop gap are now resolved; items 1, 2, 4, 5, 6, 7, 8 above remain open.
