/**
 * UserWallet WalletConnect live-event socket (desktop/Electron).
 *
...
export function walletConnectWsBase() {
...
export function walletConnectTopicUrl(topic) {
 ...
 */
export function connectWalletConnect(topic, onMessage, onClose, onError) {
...
export function sendWCRequest(ws, method, params) {
  const id = nextId++;
