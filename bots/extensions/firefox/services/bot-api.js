// TigerBots Firefox Extension API client.
//
...
// browser.storage.local under `tigerbots-token`. Firefox supports the
// promise-based `browser.*` WebExtension API natively.
//
...
// `browser` is the promise-based WebExtension global in Firefox. Fall back to
// `chrome` if a polyfill is loaded.
