 ...
 * 
 * Support for 150 Blockchains (100 EVM + 50 Non-EVM) and 200+ Tokens.
 * 
 * EVM Chains (50+):
...
export const SUPPORTED_CHAINS: Chain[] = [
  ...
  // EVM chains 51-99 (high internal IDs to avoid colliding with non-EVM ids below)
  { id: 200, name: 'Ethereum Classic', symbol: 'ETC', chainId: 61, type: 'EVM', rpcUrl: 'https://etc.rivet.link', explorerUrl: 'https://blockscout.com/etc/mainnet', icon: '🟢', decimals: 18, isActive: true, isDefault: false, color: '#328332' },
  { id: 201, name: 'HECO', symbol: 'HT', chainId: 128, type: 'EVM', rpcUrl: 'https://http-mainnet.hecochain.com', explorerUrl: 'https://hecoinfo.com', icon: '🔥', decimals: 18, isActive: true, isDefault: false, color: '#2972B2' },
  { id: 202, name: 'OKX Chain', symbol: 'OKT', chainId: 66, type: 'EVM', rpcUrl: 'https://exchainrpc.okex.org', explorerUrl: 'https://www.oklink.com/oktc', icon: '⚫', decimals: 18, isActive: true, isDefault: false, color: '#000000' },
  { id: 203, name: 'XDC Network', symbol: 'XDC', chainId: 50, type: 'EVM', rpcUrl: 'https://rpc.xdcrpc.com', explorerUrl: 'https://xdcscan.com', icon: '✖️', decimals: 18, isActive: true, isDefault: false, color: '#27AE60' },
  { id: 204, name: 'Telos', symbol: 'TLOS', chainId: 108, type: 'EVM', rpcUrl: 'https://mainnet.telos.net/evm', explorerUrl: 'https://teloscan.io', icon: '🟦', decimals: 18, isActive: true, isDefault: false, color: '#5740DD' },
  { id: 205, name: 'Meter', symbol: 'MTR', chainId: 82, type: 'EVM', rpcUrl: 'https://rpc.meter.io', explorerUrl: 'https://scan.meter.io', icon: '📏', decimals: 18, isActive: true, isDefault: false, color: '#0044CC' },
  { id: 206, name: 'Bitgert', symbol: 'BRIS', chainId: 32520, type: 'EVM', rpcUrl: 'https://rpc.bitgert.com', explorerUrl: 'https://brisescan.com', icon: '🟧', decimals: 18, isActive: true, isDefault: false, color: '#FF7A00' },
  { id: 207, name: 'Oasys', symbol: 'OAS', chainId: 248, type: 'EVM', rpcUrl: 'https://rpc.mainnet.oasys.games', explorerUrl: 'https://explorer.oasys.games', icon: '🎮', decimals: 18, isActive: true, isDefault: false, color: '#00C2A8' },
  { id: 208, name: 'Velas', symbol: 'VLX', chainId: 106, type: 'EVM', rpcUrl: 'https://evmexplorer.velas.com/rpc', explorerUrl: 'https://evmexplorer.velas.com', icon: '🟩', decimals: 18, isActive: true, isDefault: false, color: '#2275B5' },
  { id: 209, name: 'Metis Andromeda', symbol: 'METIS', chainId: 1088, type: 'EVM', rpcUrl: 'https://andromeda.metis.io', explorerUrl: 'https://andromeda-explorer.metis.io', icon: '💫', decimals: 18, isActive: true, isDefault: false, color: '#00D3C4' },
  { id: 210, name: 'SmartBCH', symbol: 'BCH', chainId: 10000, type: 'EVM', rpcUrl: 'https://rpc.smartbch.org', explorerUrl: 'https://www.smartscan.cash', icon: '💵', decimals: 18, isActive: true, isDefault: false, color: '#0AC18E' },
  { id: 211, name: 'Godwoken', symbol: 'ETH', chainId: 7141, type: 'EVM', rpcUrl: 'https://v1.mainnet.godwoken.io/rpc', explorerUrl: 'https://v1.gwscan.com', icon: '🪐', decimals: 18, isActive: true, isDefault: false, color: '#627EEA' },
  { id: 212, name: 'Ultron', symbol: 'ULX', chainId: 1231, type: 'EVM', rpcUrl: 'https://ultron-rpc.net', explorerUrl: 'https://explorer.ultron-rpc.net', icon: '⚡', decimals: 18, isActive: true, isDefault: false, color: '#FFD700' },
  { id: 213, name: 'Karak', symbol: 'ETH', chainId: 686, type: 'EVM', rpcUrl: 'https://rpc.karak.network', explorerUrl: 'https://explorer.karak.network', icon: '⚔️', decimals: 18, isActive: true, isDefault: false, color: '#627EEA' },
  { id: 214, name: 'Bifrost', symbol: 'BFC', chainId: 1515, type: 'EVM', rpcUrl: 'https://public-rpc.bifrostnetwork.com', explorerUrl: 'https://explorer.bifrostnetwork.com', icon: '🌉', decimals: 18, isActive: true, isDefault: false, color: '#FF6B6B' },
  { id: 215, name: 'TomoChain', symbol: 'TOMO', chainId: 88, type: 'EVM', rpcUrl: 'https://rpc.tomochain.com', explorerUrl: 'https://tomoscan.io', icon: '🍒', decimals: 18, isActive: true, isDefault: false, color: '#FF6666' },
  { id: 216, name: 'Omni', symbol: 'OMNI', chainId: 4893, type: 'EVM', rpcUrl: 'https://mainnet.omni.network', explorerUrl: 'https://omniexplorer.network', icon: '🔄', decimals: 18, isActive: true, isDefault: false, color: '#FFA500' },
  { id: 217, name: 'Fibonacci', symbol: 'FIBO', chainId: 2370, type: 'EVM', rpcUrl: 'https://fibonacci-rpc.com', explorerUrl: 'https://fiboscan.com', icon: '🌀', decimals: 18, isActive: true, isDefault: false, color: '#9D4EDD' },
  { id: 218, name: 'Lucky Network', symbol: 'L99', chainId: 998, type: 'EVM', rpcUrl: 'https://rpc.luckynetwork.org', explorerUrl: 'https://explorer.luckynetwork.org', icon: '🍀', decimals: 18, isActive: true, isDefault: false, color: '#27AE60' },
  { id: 219, name: 'Rupaya', symbol: 'RUPX', chainId: 499, type: 'EVM', rpcUrl: 'https://rpc.rupaya.io', explorerUrl: 'https://explorer.rupaya.io', icon: '🪙', decimals: 18, isActive: true, isDefault: false, color: '#F39C12' },
  { id: 220, name: 'Nahmii', symbol: 'NII', chainId: 5551, type: 'EVM', rpcUrl: 'https://l2.nahmii.io', explorerUrl: 'https://explorer.nahmii.io', icon: '🌙', decimals: 18, isActive: true, isDefault: false, color: '#3498DB' },
  { id: 221, name: 'SherpaX', symbol: 'KSX', chainId: 1506, type: 'EVM', rpcUrl: 'https://rpc.sherpax.io', explorerUrl: 'https://explorer.sherpax.io', icon: '🏔️', decimals: 18, isActive: true, isDefault: false, color: '#95A5A6' },
  { id: 222, name: 'Kortho', symbol: 'KTO', chainId: 8285, type: 'EVM', rpcUrl: 'https://rpc.kortho-chain.com', explorerUrl: 'https://korthochain.com', icon: '🟫', decimals: 18, isActive: true, isDefault: false, color: '#8B4513' },
  { id: 223, name: 'Tenet', symbol: 'TENET', chainId: 10058111, type: 'EVM', rpcUrl: 'https://rpc.tenet.org', explorerUrl: 'https://tenetscan.io', icon: '🔟', decimals: 18, isActive: true, isDefault: false, color: '#E67E22' },
  { id: 224, name: 'Sommelier', symbol: 'SOMM', chainId: 2330, type: 'EVM', rpcUrl: 'https://sommelierchain.com', explorerUrl: 'https://sommelierchain.com', icon: '🍷', decimals: 18, isActive: true, isDefault: false, color: '#8E44AD' },
  { id: 225, name: 'Lumoz', symbol: 'ETH', chainId: 723, type: 'EVM', rpcUrl: 'https://rpc.lumoz.org', explorerUrl: 'https://explorer.lumoz.org', icon: '✨', decimals: 18, isActive: true, isDefault: false, color: '#627EEA' },
  { id: 226, name: 'Fuse', symbol: 'FUSE', chainId: 122, type: 'EVM', rpcUrl: 'https://rpc.fuse.io', explorerUrl: 'https://explorer.fuse.io', icon: '🔌', decimals: 18, isActive: true, isDefault: false, color: '#8DC351' },
  { id: 227, name: 'GeneChain', symbol: 'DNA', chainId: 80, type: 'EVM', rpcUrl: 'https://rpc.genechain.org', explorerUrl: 'https://explorer.genechain.org', icon: '🧬', decimals: 18, isActive: true, isDefault: false, color: '#16A085' },
  { id: 228, name: 'Acala EVM', symbol: 'ACA', chainId: 787, type: 'EVM', rpcUrl: 'https://eth-rpc-acala.aca-api.network', explorerUrl: 'https://blockscout.acala.network', icon: '🅰️', decimals: 18, isActive: true, isDefault: false, color: '#E53366' },
  { id: 229, name: 'WEMIX3.0', symbol: 'WEMIX', chainId: 12052, type: 'EVM', rpcUrl: 'https://api.wemix.com', explorerUrl: 'https://explorer.wemix.com', icon: '🟫', decimals: 18, isActive: true, isDefault: false, color: '#1F1F1F' },
  { id: 230, name: 'Etherlink', symbol: 'XTZ', chainId: 100000, type: 'EVM', rpcUrl: 'https://node.mainnet.etherlink.com', explorerUrl: 'https://explorer.etherlink.com', icon: '🟦', decimals: 18, isActive: true, isDefault: false, color: '#2C7DF7' },
  { id: 231, name: 'GoChain', symbol: 'GO', chainId: 60, type: 'EVM', rpcUrl: 'https://rpc.gochain.io', explorerUrl: 'https://explorer.gochain.io', icon: '🟢', decimals: 18, isActive: true, isDefault: false, color: '#27AE60' },
  { id: 232, name: 'Lightstreams', symbol: 'PHT', chainId: 162, type: 'EVM', rpcUrl: 'https://node.mainnet.lightstreams.io', explorerUrl: 'https://explorer.lightstreams.io', icon: '💡', decimals: 18, isActive: true, isDefault: false, color: '#F1C40F' },
  { id: 233, name: 'Hpb', symbol: 'HPB', chainId: 269, type: 'EVM', rpcUrl: 'https://hpbnode.com', explorerUrl: 'https://hscan.org', icon: '🟠', decimals: 18, isActive: true, isDefault: false, color: '#FF9F00' },
  { id: 235, name: 'Valorbit', symbol: 'VAL', chainId: 38, type: 'EVM', rpcUrl: 'https://rpc.valorbit.com', explorerUrl: 'https://explorer.valorbit.com', icon: '🟣', decimals: 18, isActive: true, isDefault: false, color: '#9B59B6' },
  { id: 236, name: 'Soteria', symbol: 'SOTE', chainId: 68, type: 'EVM', rpcUrl: 'https://rpc.soteria.network', explorerUrl: 'https://explorer.soteria.network', icon: '🛡️', decimals: 18, isActive: true, isDefault: false, color: '#34495E' },
  { id: 237, name: 'IPOS Network', symbol: 'IPOS', chainId: 65535, type: 'EVM', rpcUrl: 'https://rpc.ipos.network', explorerUrl: 'https://explorer.ipos.network', icon: '📦', decimals: 18, isActive: true, isDefault: false, color: '#16A085' },
  { id: 238, name: 'Sapling', symbol: 'SAPL', chainId: 2025, type: 'EVM', rpcUrl: 'https://rpc.sapling.network', explorerUrl: 'https://explorer.sapling.network', icon: '🌿', decimals: 18, isActive: true, isDefault: false, color: '#27AE60' },
  { id: 239, name: 'Sardis', symbol: 'SARD', chainId: 11297108114, type: 'EVM', rpcUrl: 'https://rpc.sardis.network', explorerUrl: 'https://explorer.sardis.network', icon: '🟡', decimals: 18, isActive: true, isDefault: false, color: '#F1C40F' },
  { id: 240, name: 'VelaChain', symbol: 'VELA', chainId: 555, type: 'EVM', rpcUrl: 'https://rpc.velachain.org', explorerUrl: 'https://explorer.velachain.org', icon: '🟦', decimals: 18, isActive: true, isDefault: false, color: '#3498DB' },
  { id: 241, name: 'Ambros', symbol: 'AMB', chainId: 11297108112, type: 'EVM', rpcUrl: 'https://rpc.ambros.network', explorerUrl: 'https://ambrosscan.com', icon: '🟫', decimals: 18, isActive: true, isDefault: false, color: '#D35400' },
  { id: 242, name: 'Step Network', symbol: 'STEP', chainId: 1234, type: 'EVM', rpcUrl: 'https://rpc.step.network', explorerUrl: 'https://explorer.step.network', icon: '👣', decimals: 18, isActive: true, isDefault: false, color: '#2ECC71' },
  { id: 243, name: 'Planq', symbol: 'PLQ', chainId: 846, type: 'EVM', rpcUrl: 'https://evm-rpc.planq.network', explorerUrl: 'https://evm.planq.network', icon: '📱', decimals: 18, isActive: true, isDefault: false, color: '#3498DB' },
  { id: 244, name: 'Rollux', symbol: 'SYS', chainId: 570, type: 'EVM', rpcUrl: 'https://rpc.rollux.com', explorerUrl: 'https://explorer.rollux.com', icon: '⚙️', decimals: 18, isActive: true, isDefault: false, color: '#00D2D3' },
  { id: 245, name: 'Core Blockchain', symbol: 'CORE', chainId: 1116, type: 'EVM', rpcUrl: 'https://rpc.coredao.org', explorerUrl: 'https://openapi.coredao.org', icon: '⬢', decimals: 18, isActive: true, isDefault: false, color: '#1A1A1A' },
  { id: 246, name: 'Dexit', symbol: 'DXT', chainId: 4337, type: 'EVM', rpcUrl: 'https://mainnet-rpc.dexit.network', explorerUrl: 'https://explorer.dexit.network', icon: '🚪', decimals: 18, isActive: true, isDefault: false, color: '#E74C3C' },
  { id: 247, name: 'Elysium', symbol: 'LAVA', chainId: 512512, type: 'EVM', rpcUrl: 'https://rpc.elysiumchain.tech', explorerUrl: 'https://explorer.elysiumchain.tech', icon: '🌋', decimals: 18, isActive: true, isDefault: false, color: '#FF4500' },
  { id: 248, name: 'UltronGlab', symbol: 'ULG', chainId: 6877, type: 'EVM', rpcUrl: 'https://rpc.ultronglab.org', explorerUrl: 'https://explorer.ultronglab.org', icon: '⚡', decimals: 18, isActive: true, isDefault: false, color: '#F39C12' },
  { id: 249, name: 'VeloLabs', symbol: 'VELO', chainId: 512, type: 'EVM', rpcUrl: 'https://rpc.velolabs.org', explorerUrl: 'https://explorer.velolabs.org', icon: '🚴', decimals: 18, isActive: true, isDefault: false, color: '#9B59B6' },
