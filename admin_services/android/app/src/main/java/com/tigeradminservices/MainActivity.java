...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isDark = TigerAdminServicesApp.getInstance().isDarkMode();
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            else if (itemId == R.id.nav_services) fragment = new ServicesFragment();
            else if (itemId == R.id.nav_health) fragment = new HealthFragment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_theme) {
            boolean isDark = !TigerAdminServicesApp.getInstance().isDarkMode();
            TigerAdminServicesApp.getInstance().setDarkMode(isDark);
            AppCompatDelegate.setDefaultNightMode(isDark ? AppCompatDelegate.MODE_NIGHT_YES : AppCompatDelegate.MODE_NIGHT_NO);
            recreate();
            return true;
        }
