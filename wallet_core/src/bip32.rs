...
impl HDKey {
    ...
    pub fn derive(&self, index: u32) -> Result<HDKey> {
        ...
        let il_scalar = NonZeroScalar::<Secp256k1>::try_from(il)
        ...
        let parent_scalar: &k256::Scalar = parent_key.as_nonzero_scalar();
        let child_key = (*parent_scalar + *il_scalar).to_bytes();
