...
// BIP-39 English Wordlist (first 100 words - full list is 2048 words)
const BIP39_ENGLISH_WORDLIST: &[&str; 2048] = &[
    ...
    "city", "civil", "claim", "clap", "clarify", "classic", "clean", "clerk", "clever", "click",
    ...
    "emerge", "emotion", "employ", "empower", "empty", "enable", "enact", "end", "endorse",
    ...
    "reach", "react", "read", "real", "realm", "rear", "reason", "rebel", "rebuild", "recall",
    ...
    "reply", "report", "represent", "reproduce", "public", "require", "rescue", "resemble", "resist", "resource",
    ...
    "romance", "roof", "rookie", "room", "root", "rope", "rose", "rotate", "rough", "round",
    ...
    "surround", "survey", "suspect", "sustain", "swallow", "swamp", "swap", "swarm", "swear", "sweat",
    "sweep", "sweet", "swift", "swim", "swing", "switch", "sword", "symbol", "symptom", "syrup",
    ...
    "toast", "tobacco", "toddler", "toe", "together", "toilet", "token", "tomato", "tomorrow", "tone",
    ...
    "valley", "valve", "van", "vanish", "vapor", "various", "vegan", "velvet", "vendor", "venture",
...
impl Bip85Deriver {
    ...
    fn entropy_to_mnemonic(entropy: &[u8]) -> Result<String, Bip85Error> {
        // Use proper BIP-39 English wordlist
        let wordlist = BIP39_ENGLISH_WORDLIST;
        ...
        for i in 0..word_count {
            ...
            let mut index = 0u16;
            for (j, &bit) in bit_slice.iter().enumerate() {
                if bit == 1 {
                    index |= 1 << (10 - j);
                }
            }
